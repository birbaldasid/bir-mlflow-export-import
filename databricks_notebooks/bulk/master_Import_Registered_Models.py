...
def create_multi_task_job_json(input_dir, delete_model, model_rename_file, experiment_rename_file, import_permissions, import_source_tags, use_threads, num_tasks):
    ...
    for i in range(1, int(num_tasks)+1):
        task = {
            ...
            "notebook_task": {
                "notebook_path": "/Workspace/Users/birbal.das@databricks.com/mlflow_export_import_with_import_changes/bir-mlflow-export-import/databricks_notebooks/bulk/Import_Registered_Models",
                "base_parameters": {
